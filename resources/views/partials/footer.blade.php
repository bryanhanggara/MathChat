    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="text-white">Empowering the Math community<br/>to connect. share and learn.</p>
        </div>
          ...
          <div class="d-flex flex-column flex-lg-row justify-content-end">
            <div class="d-flex flex-column me-140px mb-3 mb-lg-0">
              ...
              <ul class="list-unstyled">
                <li class="text-white"><a href="mailto:hi@mathchat.my.id">hi@matchat.my.id</a></li>
              </ul>
            </div>

<nav class="navbar navbar-t navbar-expand-lg position-fixed w-100 mb-5">
          ...
          <li class="nav-item">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="{{route('convert')}}">Convert</a></li>
                </ul>
              </div>
          </li>
        </ul>
...
<br><br><br>
<nav class="navbar navbar-b navbar-expand-lg position-fixed w-100 mb-5">
  <div class="container flex justify-content-between">
    <a class="navbar-link" href="{{ route('home') }}">
      <img class="h-32px" src="{{ url('assets/images/logo.png') }}" alt="Laracuss Logo">
    </a>
